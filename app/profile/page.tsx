    ...
    <div className="prof-wrap">
      ...
      <div className="prof-hdr">
        ...
        {editing ? (
          <div className="edit-fields">
            <input className="edit-input edit-name" placeholder="Full name" value={editName}
              onChange={e => setEditName(e.target.value)} maxLength={60} />

            <div className="desig-wrap">
              <input className="edit-input edit-desig" placeholder="Designation / Job title" value={editDesig}
              ...
              {showSugg && (
                <div className="desig-sugg">
                  {DESIGNATION_SUGGESTIONS
                    ...
                    .slice(0, 5)
                    .map(s => (
                      <button key={s} className="sugg-item" onMouseDown={() => { setEditDesig(s); setShowSugg(false); }}>{s}</button>
                    ))}
                </div>
              )}
            </div>
            ...
            <div className="country-field">
              <select className="edit-input edit-country" value={editCountry} onChange={e => setEditCountry(e.target.value)}>
          ...
          <>
            ...
            {profile?.designation && <div className="prof-desig">{profile.designation}</div>}
      ...
      <div className="prof-body">
        ...
        <div className="theme-grid">
          {THEMES.map(t => (
            <button key={t.id} className={`th-card${activeTheme === t.id ? ' active' : ''}`}
        ...
        <div className="info-card">
          ...
          {countryInfo && (
            <div className="info-row">
              ...
              <span className="info-val">{countryInfo.flag} {countryInfo.name}</span>
            </div>
          )}
          <div className="info-row">
      ...
      <style jsx>{`
        ...
        .av-edit-btn {
          ...
          background: var(--purple); border: 2px solid var(--surf);
          border-radius: 50%;
          display: flex; align-items: center; justify-content: center;
        ...
        .prof-desig { font-size: 12px; color: var(--purple); font-weight: 600; margin-top: 2px; }
        .prof-email-row {
        ...
        .ps-l { font-size: 10px; color: var(--mid); margin-top: 2px; font-weight: 500; text-transform: uppercase; letter-spacing: .4px; }
        ...
        .th-card:hover  { border-color: var(--purple); background: var(--surf2); }
        ...
        .th-tag   { font-size: 9px; color: var(--mid); font-weight: 600; letter-spacing: .5px; }
        ...
        .badge-item.lit .badge-lbl { color: rgba(251,191,36,.9); }
        ...
        .info-email-row {
          display: flex; align-items: center; gap: 8px; max-width: 60%;
        }
        ...
        .eye-btn-sm {
          ...
          color: var(--mid); cursor: pointer;
          display: flex; align-items: center;
          border-radius: 4px; line-height: 0; flex-shrink: 0;
        }
        ...
        .signout-btn {
          ...
          border: 1.5px solid rgba(255,107,138,.35);
